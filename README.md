...
- **test_1.r** -- causal structure from (Harbecke, 2018) with an added upper level

- **test_2.r** -- a causal chain with two levels, a very simple multi-level structure 

- **test_3.r** -- a variation of test_2.r which involves disjunctions, conjunctions and negations

- **test_4.r** -- a simple single level structure

- **test_5.r** -- the example data set "women" from CNA

- **test_6.r** -- the example data set "volatile" from CNA (circular causal structure)

- **test_7.r** -- the example data set "highdim" from CNA (it is not intended to be executed without further reduction of the data set)

- **test_8.r** -- an adjustable test frame, specify a formula and generate the respective truth table and Coincidence Analysis

- **test_9.r** -- causal structure from the introductory part of "An Algorithm for Boolean Constitutive Inference for Mechanistic Explanation and Potential Measures of Simplicity"
